<script lang="ts">
  ...
  import {
    ...
    type JuniorHackfestRegistration
  } from '$lib/types/hackfest';

  let { data } = $props();

  const stepItems: StepItem<JuniorHackfestRegistration>[] = [
    {
      label: 'Team Info',
      component: TeamInfo,
...
<div class="pointer-events-none fixed inset-0 -z-10 overflow-hidden select-none">
  ...
  <Star class="absolute bottom-32 -left-10 w-40 rotate-90 opacity-15 blur-[2px] dark:opacity-30" />
